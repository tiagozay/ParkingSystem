...
export default function CadastrarTiket() {
    ...
    const [numeroVaga, setNumeroVaga] = useState<string | null>(null);
    ...
    function aoDigitarNumeroVaga(event: React.ChangeEvent<HTMLInputElement>)
    {
        setNumeroVaga(event.target.value);
    }
                ...
                <div id="formAdcTiketView">
                    <form id="formularioCadatrarTiket" className="formPadrao" onSubmit={aoCadastrarTiket}>
                        ...
                        <div className="linhaInputs">
                            ...
                            <label>
                                Número vaga
                                <input type="text" name="numeroDaVaga" onChange={aoDigitarNumeroVaga} value={!numeroVaga ? "" : numeroVaga}/>
                            </label>
                        </div>
